...
OUT_DIR = r'your address\EPSpec_ An Evidence-Guided, Prior-Retrieval Agent for NIR Band Selection\Experiments\Ablation\Results\大模型和温度\corn\plsr_joink-deepseek'
