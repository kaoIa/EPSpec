...
CASE = {
    ...
    "data_csv": Path(
        ...
        r"\Data\Raw Data\soil.csv"
    ),

    "metrics_csv": Path(
        r"your address"
        r"\EPSpec_ An Evidence-Guided, Prior-Retrieval Agent for NIR Band Selection"
        r"\Experiments\wavelength selection\soil\plsr_joink\metrics_per_fold.csv"
    ),
    "ranking_dir": Path(
        r"your address"
        r"\EPSpec_ An Evidence-Guided, Prior-Retrieval Agent for NIR Band Selection"
        r"\Experiments\wavelength selection\soil\plsr_joink\EP"
    ),

    "ipls_coeff_csv": Path(
        r"your address"
        r"\EPSpec_ An Evidence-Guided, Prior-Retrieval Agent for NIR Band Selection"
        r"\Experiments\ipls and cars\soil\ipls_plsr_cv_results_no_full_lv_cap\coefficients.csv"
    ),
    "cars_coeff_csv": Path(
        r"your address"
        r"\EPSpec_ An Evidence-Guided, Prior-Retrieval Agent for NIR Band Selection"
        r"\Experiments\ipls and cars\soil\cars_plsr_cv_results_no_full_lv_cap\coefficients.csv"
    ),
    ...
    "out_basename": "Fig6_soil_interpretability_case_final_consensus_only",
