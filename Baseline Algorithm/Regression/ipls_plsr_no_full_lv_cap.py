...
OUT_DIR = r'your address\EPSpec_ An Evidence-Guided, Prior-Retrieval Agent for NIR Band Selection\Experiments\ipls and cars\shootout\ipls_plsr_cv_results_no_full_lv_cap'
